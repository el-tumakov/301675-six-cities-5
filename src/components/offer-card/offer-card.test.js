...
import {SortTypes, CITIES, AuthorizationStatus, CardImageSizes} from "../../const";
...
it(`Should OfferCardMain render correctly`, () => {
...
it(`Should OfferCardFavorite render correctly`, () => {
  const store = mockStore({
    [NameSpace.DATA]: {
      offers: OFFERS,
      userData: {},
...
it(`Should OfferCardRoom render correctly`, () => {
  const store = mockStore({
    [NameSpace.DATA]: {
      offers: OFFERS,
      userData: {},
